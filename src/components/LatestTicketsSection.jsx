...
const LatestTicketsSection = () => {
  ...
  if (loading) return <div className="text-center py-10 text-sm text-gray-500 bg-white dark:bg-[#0d0811]">Loading Latest Tickets...</div>;
    ...
    <section className="w-full bg-white dark:bg-[#0d0811] py-12 border-b border-gray-100 dark:border-neutral-900/40 transition-colors duration-300">
      <div className="w-full max-w-7xl mx-auto p-4 md:p-6 space-y-6" style={{ fontFamily: 'sans-serif' }}>
        ...
        <div className="border-b border-gray-100 dark:border-neutral-800 pb-4">
          <h2 className={`${title} text-2xl font-bold m-0 text-gray-900 dark:text-white`}>🆕 Recently Added Tickets</h2>
              ...
              <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                ...
                <div className="flex items-center justify-between border-t border-gray-50 dark:border-neutral-800/40 pt-2.5">
                  ...
                  <div className="text-right">
                    ...
                    <p className={`${text} text-xs font-semibold m-0 text-gray-800 dark:text-neutral-200`}>{ticket.quantity || ticket.ticketQuantity || 0} Pcs</p>
                  </div>
                </div>
