...
const AllTicketsPage = () => {
  ...
  // নতুন ফিল্টার এবং সর্ট স্টেটসমূহ
  ...
  useEffect(() => {
    ...
    let result = tickets.filter(ticket => {
      ...
      const matchTransport = transportFilter === "" || ticket.transportType?.toLowerCase() === transportFilter.toLowerCase();
      
      return matchFrom && matchTo && matchTransport;
    });

    // খ) এবার সর্টিং অ্যাপ্লাই করা হচ্ছে
    if (sortBy === "lowToHigh") {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-6 space-y-6" style={{ fontFamily: 'sans-serif' }}>
      ...
      {/* 🛠️ সার্চ, ফিল্টার এবং সর্ট প্যানেল (Control Panel) */}
