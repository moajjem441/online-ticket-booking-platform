...
export default function LoginPage() {
  ...
  return (
    <div className="w-full min-h-[85vh] flex items-center justify-center px-4 relative transition-colors">
      {/* Background Glow */}
      <div className="absolute w-[400px] h-[400px] bg-blue-600/5 dark:bg-blue-600/10 rounded-full blur-[100px] top-1/4 right-1/4 pointer-events-none" />
      ...
      <div className={`w-full max-w-md p-8 shadow-2xl z-10 ${card}`}>
        ...
        <div className="flex flex-col items-center gap-2 mb-6">
          ...
          {/* ⚠️ মিউটেড টোকেন */}
          <p className={`text-xs ${muted}`}>Sign in to your TicketBari account</p>
        </div>
